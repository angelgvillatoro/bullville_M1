...
\subsubsection{Nudging: Flow Around a Square Cylinder}

Zauner et al. \parencite{zauner2020nudging} applied nudging-based DA to the turbulent wake behind a square cylinder at a Reynolds number of 22,000. They used synthetic velocity field data from DNS as observational input and applied nudging in an unsteady RANS (URANS) solver. The study showed:
\begin{itemize}
  \item Recovery of both large-scale vortex shedding and small-scale Kelvin–Helmholtz instabilities.
  \item Use of Spectral Proper Orthogonal Decomposition (SPOD) to quantify spectral agreement between assimilated and reference flows.
  \item Importance of observation resolution in capturing high-frequency content.
\end{itemize}
